...
<footer class="footer footer_type_1 dark">
    ...
    <div class="footer-middle container" dir="rtl">
        <div class="row row-cols-lg-5 row-cols-2">
            <div class="footer-column footer-store-info col-12 mb-4 mb-lg-0">
                <div class="logo">
                    <a href="{{url('/')}}">
                        <img src="{{asset('assets/new_website/images/logo2.png')}}" alt="رشة سحرية " class="logo__image d-block">
                    </a>
                </div><!-- /.logo -->
                <p class="footer-address"> السعودية ، الرياض  </p>

                <p class="m-0">
                    <strong class="fw-medium">info@magical-spray.com</strong>
                </p>
                <p>
                    <strong class="fw-medium"> 000 000 000 </strong>
                </p>
            ...
            <div class="footer-column footer-menu mb-4 mb-lg-0">
                <h6 class="sub-menu__title text-uppercase"> روابط  </h6>
                <ul class="sub-menu__list list-unstyled">
                    <li class="sub-menu__item"><a href="{{url('user/profile')}}" class="menu-link menu-link_us-s">حسابي </a></li>
                    <li class="sub-menu__item"><a href="{{url('contact')}}" class="menu-link menu-link_us-s"> تواصل معنا  </a></li>
                    <li class="sub-menu__item"><a href="#" class="menu-link menu-link_us-s"> شروط الخصوصية  </a></li>
                    <li class="sub-menu__item"><a href="#" class="menu-link menu-link_us-s"> شروط الاستخدام  </a></li>
                </ul>
            </div><!-- /.footer-column -->

            <div class="footer-column footer-menu mb-4 mb-lg-0">
                <h6 class="sub-menu__title text-uppercase"> الاقسام  </h6>
                @php
                    $categories = \App\Models\admin\Category::all();
 @endphp
                <ul class="sub-menu__list list-unstyled">
                    @foreach($categories as $category)
                        <li class="sub-menu__item"><a href="{{url("category/".$category['slug'])}}" class="menu-link menu-link_us-s"> {{$category['name']}} </a></li>
                    @endforeach
    ...
    <div class="footer-bottom container">
        <div class="d-block d-md-flex align-items-center">
            <span class="footer-copyright me-auto">©2024 magical-spray</span>
...
<div class="aside aside_right overflow-hidden customer-forms" id="customerForms">
    <div class="customer-forms__wrapper d-flex position-relative">
        <div class="customer__login">
            ...
            <form action="https://uomo-html.flexkitux.com/Demo15/login_register.php" method="POST" class="aside-content">
        ...
        <div class="customer__register">
            ...
            <form action="https://uomo-html.flexkitux.com/Demo15/login_register.php" method="POST" class="aside-content">
                ...
                <div class="customer-option mt-4 text-center">
                    ...
                    <a href="{{url('user/login')}}" class="btn-text js-show-login">Login</a>
                </div>
            </form>
...
<div class="aside aside_right overflow-hidden cart-drawer" id="cartDrawer">
    ...
    <div class="aside-content cart-drawer-items-list">
        <div class="cart-drawer-item d-flex position-relative">
            <div class="position-relative">
                <a href="product1_simple.php">
                    <img loading="lazy" class="cart-drawer-item__img" src="{{asset('assets/new_website/images/cart-item-1.jpg')}}" alt="">
                </a>
            </div>
        ...
        <div class="cart-drawer-item d-flex position-relative">
            <div class="position-relative">
                <a href="product1_simple.php">
                    <img loading="lazy" class="cart-drawer-item__img" src="{{asset('assets/new_website/images/cart-item-3.jpg')}}" alt="">
                </a>
            </div>
            <div class="cart-drawer-item__info flex-grow-1">
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="sitemap d-flex">
            <div class="w-50 d-none d-lg-block">
                <img loading="lazy" src="{{asset('assets/new_website/images/nav-bg.jpg')}}" alt="Site map" class="sitemap__bg">
                    ...
                    "prevEl": ".modal-dialog.quick-view .product-single__media .swiper-button-prev"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="{{asset('assets/new_website/images/products/quickview_1.jpg')}}" alt="">
                                </div>
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="{{asset('assets/new_website/images/products/quickview_2.jpg')}}" alt="">
                                </div>
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="{{asset('assets/new_website/images/products/quickview_3.jpg')}}" alt="">
                                </div>
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="{{asset('assets/new_website/images/products/quickview_4.jpg')}}" alt="">
                                </div>
                            </div>
...
<script src="{{asset('assets/new_website/js/plugins/jquery.min.js')}}"></script>
<script src="{{asset('assets/new_website/js/plugins/bootstrap.bundle.min.js')}}"></script>
<script src="{{asset('assets/new_website/js/plugins/bootstrap-slider.min.js')}}"></script>

<script src="{{asset('assets/new_website/js/plugins/swiper.min.js')}}"></script>
<script src="{{asset('assets/new_website/js/plugins/countdown.js')}}"></script>
<script src="{{asset('assets/new_website/js/plugins/jquery.fancybox.js')}}"></script>

<!-- Footer Scripts -->
<script src="{{asset('assets/new_website/js/custome.js')}}"></script>
<script src="{{asset('assets/new_website/js/theme.js')}}"></script>
