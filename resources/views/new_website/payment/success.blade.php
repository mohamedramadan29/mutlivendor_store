...
@section('title')
    اتمام عملية الدفع بنجاح
@endsection
@section('content')
    <main>
        <div class="mb-4 pb-4"></div>
        <section class="shop-checkout container" dir="rtl">
            <h2 class="page-title"> اتمام عملية الدفع بنجاح   </h2>
            <div class="checkout-steps">
                ...
                <a href="{{url('checkout')}}" class="checkout-steps__item active">
                    ...
                    <span class="checkout-steps__item-title">
            <span> اتمام عملية الدفع بنجاح   </span>
            <em>  اتمام عملية الدفع بنجاح   </em>
          </span>
                </a>
