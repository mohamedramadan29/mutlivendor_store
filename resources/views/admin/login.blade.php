                                        ...
                                        <div class="main-signup-header">
                                            ...
                                            <form action="{{route('admin_login')}}" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label>البريد الالكتروني </label> <input class="form-control" name="email" placeholder="البريد الإلكتروني" type="email" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Password</label> <input class="form-control" name="password" placeholder="كلمة المرور" type="password" required>
