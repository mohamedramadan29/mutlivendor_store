                                            ...
                                            <select required class='form-control select2' name='category_id'>
                                                ...
                                                @foreach ($categories as $section)
                                                    ...
                                                    @foreach($section['categories'] as $categoryy)
                                                        <option @if($categoryy['id'] == $product['category_id']) selected @endif value="{{$categoryy['id']}}">  {{$categoryy['name']}} &nbsp;&nbsp; << </option>
                                                        @foreach($categoryy['subcategory'] as $subcategory)
                                                            <option @if($subcategory['id'] == $product['category_id']) selected @endif value="{{$subcategory['id']}}">  {{$subcategory['name']}} &nbsp;&nbsp; <<< </option>
                                                        @endforeach
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select required class='form-control select2' name='brand_id'>
                                                ...
                                                <option @if($product['brand_id'] == 0) selected @endif value="0"> لا يوجد</option>
...
{{--                                            <img class="img-thumbnail img-fluid" width="80px" src="{{ asset('public/'.Storage::url($product['image'])) }}">--}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select required class='form-control select2' name='status'>
                                                ...
                                                <option @if($product['status'] == 0) selected @endif value='0'> غير فعال</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <select required class='form-control select2' name='is_feature'>
                                                ...
                                                <option @if($product['is_feature'] == 1) selected @endif value='1'> مميز</option>
                                                <option @if($product['is_feature'] == 0) selected @endif value='0'> عادي</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <select required class='form-control select2' name='best_seller'>
                                                    ...
                                                    <option @if($product['best_seller'] == 1) selected @endif  value='1'> نعم </option>
                                                    <option @if($product['best_seller'] == 0) selected @endif value='0'>  لا </option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <button class='btn btn-primary' type='submit'> تعديل النتج  </button>
                        </div>
                    </form>
