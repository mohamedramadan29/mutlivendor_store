        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الرئيسية </h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ الأقسام الرئيسية للمتجر  </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-primary btn-sm"
                                                    data-target="#edit_model_{{$section['id']}}"
                                                    data-toggle="modal"> تعديل <i class="fa fa-edit"></i></button>
                                            <button data-target="#delete_model_{{$section['id']}}"
