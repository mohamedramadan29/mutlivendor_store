        ...
        <div class="main-header-left ">
            <div class="responsive-logo">
                ...
                <a href="{{ url('/' . ($page = 'index')) }}"><img
                        ...
                        alt="logo"></a>
                <a href="{{ url('/' . ($page = 'index')) }}"><img
                        src="{{ URL::asset('assets/admin/img/brand/favicon.png') }}" class="logo-2"
                        alt="logo"></a>
                <a href="{{ url('/' . ($page = 'index')) }}"><img
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    @if(!empty(Auth::guard('admin')->user()->image))
                        <a class="profile-user d-flex" href=""><img alt=""
                                                                    src="{{Storage::url(Auth::guard('admin')->user()->image)}}"></a>
                    @else
                        <a class="profile-user d-flex" href=""><img alt=""
                    ...
                    <div class="dropdown-menu">
                            ...
                            <div class="d-flex wd-100p">
                                @if(!empty(Auth::guard('admin')->user()->image))
                                    <div class="main-img-user"><img alt=""
                                                                    src="{{Storage::url(Auth::guard('admin')->user()->image)}}" class="">
                                    </div>
                                @else
                                    <div class="main-img-user"><img alt=""
                                                                    src="{{ URL::asset('assets/admin/img/faces/6.jpg') }}" class="">
                                    </div>
                                @endif
                        ...
                        @if (auth('admin')->check())
                            <a class="dropdown-item" href="{{ route('admin_logout') }}"> <i class="bx bx-log-out-circle"></i>  تسجيل خروج </a>
                        ...
                        @else
                            <a class="dropdown-item" href="{{ route('logout.admin') }}"
                                ...
                                تسجيل خروج </a>
                            <form id="logout-form2" action="{{ route('logout.admin') }}" method="post"
                                style="display: none">
                                @csrf
                            </form>
                        @endif
